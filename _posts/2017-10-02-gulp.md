...
Eftersom vi vet om globbing nu kan vi ersätta arc/css/styles.scss med ett scss/**/*.scs mönster som matchar alla filer med en .scss-förlängning i app / scss eller en barnkatalog.
